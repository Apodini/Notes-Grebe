...
public protocol NotesServiceService {
...
public final class NotesServiceServiceClient: GRPCClient, NotesServiceService {
  ...
  public func createNote(_ request: CreateNoteRequest, callOptions: CallOptions? = nil) -> UnaryCall<CreateNoteRequest, CreateNoteResponse> {
  ...
  public func deleteNotes(callOptions: CallOptions? = nil) -> ClientStreamingCall<DeleteNotesRequest, DeleteNotesResponse> {
  ...
  public func getNotes(_ request: GetNotesRequest, callOptions: CallOptions? = nil, handler: @escaping (GetNotesResponse) -> Void) -> ServerStreamingCall<GetNotesRequest, GetNotesResponse> {
  ...
  public func switchTitleContent(callOptions: CallOptions? = nil, handler: @escaping (SwitchTitleContentResponse) -> Void) -> BidirectionalStreamingCall<SwitchTitleContentRequest, SwitchTitleContentResponse> {
...
public protocol NotesServiceProvider: CallHandlerProvider {
...
extension NotesServiceProvider {
  public var serviceName: String { return "NotesService" }
